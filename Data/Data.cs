...
namespace Data
{
    public class Data
    {
        ...
        public Data()
        {
            ...
            feesten.Add(new Feest(10, Feest.BetalingKeuze.Organisatie, true, 8, Feest.ConsumptieKeuze.Bonnen, 2, true, true, "appelsap, smirnoff ice", true, "appels, chips",DateTime.Now, DateTime.Now, null));
        }
